...
public class travelListFragment extends ListFragment {
    ...
    /**
     * A Travel implementation of the {@link Callbacks} interface that does
     * nothing. Used only when this fragment is not attached to an activity.
     */
    private static Callbacks sTravelCallbacks = new Callbacks() {
        @Override
        public void onItemSelected(String id) {
        }
    };
   ...
   @Override
    ...
    public void onDetach() {
        ...
        // Reset the active callbacks interface to the Travel implementation.
        mCallbacks = sTravelCallbacks;
    }
